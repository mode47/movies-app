    ...
    <div class="py-6 px-5">
        <div>
            <a href="/shows/{{ $show['id']}}">
                <img src="{{'https://image.tmdb.org/t/p/w500/'.$show['poster_path'] }}" alt="Blog Post illustration" class="rounded-xl">
            </a>
        </div>
    </div>
    <div class="mt-2">
        <a href="{{ 'show/'.$show['id'] }}" class="text-lg mt-2 hover:text-gray-300">{{ $show['name']}}</a>
    </div>
